...
// Route::group(['middleware' => ['role:admin']], function () {
    ...
    Route::post('supprimer/utilisateur/{idUtilisateur}', [UserRolePermissionController::class, 'supprimerUtilisateur'])
    ...
    Route::post('modifier/roles/permissions/utilisateur/ensemble', [UserRolePermissionController::class, 'modifierRolesPermissionsUtilisateurEnsemble']) //
        ->name('modifier.roles.permissions.utilisateur.ensemble');


    Route::post('ajouter/permission', [UserRolePermissionController::class, 'ajouterPermission'])
        ->name('ajouter.permission');

    Route::post('modifier/permission', [UserRolePermissionController::class, 'modifierPermission'])
