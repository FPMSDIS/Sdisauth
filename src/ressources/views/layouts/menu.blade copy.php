<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        {{-- @role('admin') --}}
            <!-- Layouts -->
            <li
                class="menu-item {{ Request::is('liste/permissions*') || Request::is('liste/roles*') || Request::is('liste/utilisateurs*') ? 'active open' : '' }}">
                @can('voir_gestion_des_utilisateurs')
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        <i class="menu-icon tf-icons bx bx-layout"></i>
                        {{-- <div data-i18n="Layouts">Parametrage de Compte</div> --}}
                ...
                <ul class="menu-sub">
                    ...
                    {{-- <li class="menu-item {{ Request::is('gestionsms/synthese/sms') ? 'active' : '' }}">
                        <a href="{{ route('synthese') }}" class="menu-link">
                            <div data-i18n="Notifications">Synthèse utilisation</div>
                        </a>
                    </li> --}}
                    @can("lister_historique_des_achats")
                        <li class="menu-item {{ Request::is('gestionsms/historique/achats') ? 'active' : '' }}">
                            <a href="{{ route('historique.achats') }}" class="menu-link">
                                <div data-i18n="Connections">Historique achats</div>
                            </a>
                        </li>
                    @endcan
                </ul>
