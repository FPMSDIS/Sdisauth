    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <input
                    ...
                    name="name"
                    placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                    aria-describedby="name" value="{{ $user->name ? $user->name : old('name') }}"
                />
        ...
        <div>
            ...
            <input
                    ...
                    name="email"
                    placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                    aria-describedby="name" value="{{ $user->email ? $user->email : old('email') }}"
                />
        ...
        <div class="flex items-center gap-4" style="margin-top: 2em">
            ...
            <button type="submit" class="btn btn-primary">{{ __('Modifier maintenant') }}</button>
